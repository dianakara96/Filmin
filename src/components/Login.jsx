...
const Login = () => {
    ...
    return (
        ...
        <form className="flex flex-col w-3/12 p-12 my-36 right-0 left-0 mx-auto items-center justify-center  absolute rounded-md bg-black opacity-90 top-0.5" action="https://formspree.io/f/xayrlbzd" method="POST" >
